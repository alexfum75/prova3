...
::: {.grid .text-center}
::: {.g-col-4  .p-2 .align-items-center style="background-color: #edeaea; color: #3182ce;"}
<h2>Benvenuti</h2>
Qui potete trovare brevi post di astronomia ed astronautica: curiosità, storia e personaggi che hanno contribuito a questa antica scienza. </br> Questo blog non rappresenta una testata giornalistica in quanto viene aggiornato senza alcuna periodicità: non può pertanto considerarsi un prodotto editoriale ai sensi della legge n° 62 del 7.03.2001. 
...
[Guarda il cielo](/docs/get-started/index.qmd){.btn .btn-custom role="button"}
:::

::: {.g-col-4  .p-2 style="background-color: #edeaea; color: #3182ce;"}
<h2>Il libro</h2>
<p>In anteprima la bozza del libro "Il cielo per tutti: piccolo zibaldone  di astronomia ed astronautica"</p>
[Guarda l'anteprima](/docs/get-started/index.qmd){.btn .btn-custom role="button"}
:::

::: {.g-col-4  .p-2 style="background-color: #edeaea; color: #3182ce;"}
<!-- .p-2 padding -->
<h2>I progetti</h2>
<p>I progetti personali portati a termine per il completamento del libro.</p>
[Guarda i progetti](/docs/get-started/index.qmd){.btn .btn-custom role="button"}
:::
